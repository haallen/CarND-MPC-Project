...
I finally settled on N=.8 and dt=0.08 for my project after trying many values. This corresponds to prediction/optimization of a trajectory of 0.64 seconds long. I initially tried larger values of dt (e.g. 0.15) and found that this worked well with my car at low speeds (ref_v=20). When I tried to increase the speed, this led to unstable behavior I believe primarily due to the fact that the spacing between points in the trajectory is too large for that speed. I then started trying smaller values of dt at higher speeds until I settled on the current values. My current values of N, dt, and cost parameters work well at speeds up to 60 (and maybe 65 if you're adventurous). 
